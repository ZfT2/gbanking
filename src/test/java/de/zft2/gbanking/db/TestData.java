...
public class TestData {
	...
	public static BankAccount createSampleAccount(Integer bankAccessId) {
		...
		acc.setIban("DE" + (100000000 + randomNumber));
		acc.setBic("TESTBIC");
		acc.setNumber(String.valueOf(randomNumber));
		acc.setSubnumber("00");
	...
	public static Booking createBookingWithParams(Integer bankAccountId, Integer recipientId, String purpose, double amount, BookingType bookingType) {
		Booking booking = new Booking();
		booking.setAccountId(bankAccountId);
		booking.setRecipientId(recipientId);
		booking.setDateBooking(LocalDate.now(ZoneId.systemDefault()));

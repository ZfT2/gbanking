...
class LocalizedEnumValueTest {
	...
	void allLocalizedEnumsShouldHaveGermanAndEnglishValues() {
		...
		assertLocalized(StockTransactionType.values());
		assertLocalized(StockPriceBasis.values());
		assertLocalized(StockPriceType.values());
		assertLocalized(StockQuantityType.values());
		assertLocalized(StockQuotationType.values());
		assertLocalized(StockSecurityState.values());
		assertLocalized(StockSecurityType.values());

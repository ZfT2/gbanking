...
class AccountStatementFileManager {
	...
	AccountStatementFileManager() {
		this(resolveStatementsDirectory(), AccountStatementSettings::isFileEncryptionEnabled);
	}

	AccountStatementFileManager(Path statementsDirectory) {
		this(statementsDirectory, () -> false);
	}

	AccountStatementFileManager(Path statementsDirectory, BooleanSupplier encryptionEnabled) {

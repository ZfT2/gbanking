...
INSERT OR IGNORE INTO parameterData (pdKey, pdType, updatedAt) VALUES %s;
...
INSERT OR IGNORE INTO bankAccess_parameterData (bankAccess_id, parameterData_id, pdValue, updatedAt) VALUES %s;

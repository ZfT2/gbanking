...
SELECT id, account_id, bookingType, bookingSource, dateBooking, dateValue, purpose, amount, currency, sepaCustomerRef, sepaCreditorId, sepaEndToEnd, sepaMandate, sepaPersonId, sepaPurpose, sepaTyp, crossAccount_id, updatedAt 
FROM booking;

[SQL_SELECT_ALL_BOOKINGS_BY_ACCOUNT]
SELECT id, account_id, bookingType, bookingSource, dateBooking, dateValue, purpose, amount, currency, sepaCustomerRef, sepaCreditorId, sepaEndToEnd, sepaMandate, sepaPersonId, sepaPurpose, sepaTyp, crossAccount_id, recipient_id, category_id, crossBooking_id, updatedAt 
FROM booking 
where account_id = ?;
...
[SQL_INSERT_BOOKING]
INSERT INTO booking (account_id, dateBooking, dateValue, purpose, amount, currency, sepaCustomerRef, sepaCreditorId, sepaEndToEnd, sepaMandate, sepaPersonId, sepaPurpose, sepaTyp, bookingType, bookingSource, crossAccount_id, recipient_id, category_id, crossBooking_id, updatedAt) 
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);

[SQL_UPDATE_BOOKING]
UPDATE booking 
SET account_id = ?, dateBooking = ?, dateValue = ?, purpose = ?, amount = ?, currency = ?, sepaCustomerRef = ?, sepaCreditorId = ?, sepaEndToEnd = ?, sepaMandate = ?, sepaPersonId = ?, sepaPurpose = ?, sepaTyp = ?, bookingType = ?, bookingSource = ?, crossAccount_id = ?, recipient_id = ?, category_id = ?, crossBooking_id = ?, updatedAt = ? 
WHERE id = ?;

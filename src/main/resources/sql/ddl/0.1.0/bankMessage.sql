...
[SQL_SETUP_CREATE_INDEX_BANKMESSAGE_BANKACCESS]
CREATE INDEX IF NOT EXISTS idx_bankmessage_bankaccess ON bankMessage (bankAccess_id, versionDate, retrievedAt);

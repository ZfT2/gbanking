...
> ⚠ **Beta Status**
>
> **Dieses Projekt befindet sich aktuell im Beta-Stadium.**
>
> **Echte Bankzugänge und produktive Konten sollten mit Vorsicht verwendet werden. Über dieses Programm ausgelöste Aufträge müssen vor der finalen Bestätigung sorgfältig geprüft werden **.


> ** Real bank access credentials and production accounts should be used with caution. Orders triggered by this program must be carefully reviewed before final confirmation. **.
